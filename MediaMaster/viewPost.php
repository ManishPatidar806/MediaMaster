...
<body>
  ...
  <footer id="footer">
    ...
    <div id="slideContainer">
      <div id="slide1">
        <div id="desc">
          <div id="title">Media Master</div>
          <div id="details">
            Media Master is a type of Content Management System.
          </div>
        </div>
        <div id="socialBtnContainer">
          <a href="https://www.facebook.com/profile.php?id=100028745823950&mibextid=ZbWKwL"><i
